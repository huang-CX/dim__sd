...
pub_set_joint = rospy.Publisher('/robotis/set_joint_states', JointState, queue_size=10)
...
def listener():
    ...
    rospy.Subscriber("/robotis/present_joint_states", JointState, call.callbackJointStates)
