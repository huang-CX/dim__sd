...
from env.env_wrapper import MetaWrapper, RandomWrapper
...
def test_sac(args=get_args()):
    if args.watch:
        env = RandomWrapper(Exhx5WalkEnv(render=True))
        train_envs = env
        test_envs = env
        args.training_num = 1
        args.test_num = 1
        ...
        # )
        env = RandomWrapper(Exhx5WalkEnv())
    ...
    if not args.resume_path:
        ...
        log_file = f'seed_{args.seed}_{t0}-{args.task.replace("-", "_")}_sac_{args.actor_lr}_{args.critic_lr}'
