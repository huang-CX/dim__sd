...
def get_args():
    ...
    parser.add_argument('--pre-train-id', type=int, default=3)
    ...
    parser.add_argument('--augmentation-ratio', type=int, default=2)
    parser.add_argument(
        '--watch',
        default=False,
        action='store_true',
...
def test_ppo(args=get_args()):
    ...
    if args.resume:
        args.resume_path = args.resume_path + '_' + str(args.pre_train_id)
    ...
    log_path = os.path.join(args.logdir, args.task, 'DA_MBRL_epoch_500_' + str(args.subtask), log_file)
    # if args.resume:
